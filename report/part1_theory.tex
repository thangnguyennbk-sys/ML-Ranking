...
Chương 10 của~\cite{mohri2018foundations} trình bày một cách hệ thống 
...
\begin{itemize}
  \item \textbf{10.1 $\to$ 10.2:} Định nghĩa ranking loss và 
  ...
  \item \textbf{10.2 $\to$ 10.3:} Chặn tổng quát hoá cho thấy 
  ...
  \item \textbf{10.3 $\to$ 10.4:} SVM Ranking có độ phức tạp 
