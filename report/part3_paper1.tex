...
\begin{quote}
\textbf{Liên hệ với lý thuyết (Chương 10):}
Định nghĩa về rủi ro xếp hạng và bộ xếp hạng Bayes hoàn toàn nhất quán với định nghĩa trong Mục 10.5, Chương 10. Tuy nhiên, bài báo bổ sung thêm khái niệm \emph{hối tiếc xếp hạng} (rank regret) -- một chỉ số mạnh hơn đo lường khoảng cách đến hiệu suất tối ưu mà giáo trình chưa xoáy sâu.
\end{quote}
...
\begin{quote}
\textbf{Liên hệ với lý thuyết (Chương 10):}
Chứng minh của bài báo sử dụng \textbf{kỹ thuật rút gọn} xếp hạng về phân loại bằng cách tạo không gian mới gồm các cặp mẫu $\tilde{x} = (x, x')$. Đây chính là kỹ thuật nền tảng được dùng trong Chương 10 để xây dựng thuật toán RankSVM (Mục 10.3) và RankBoost (Mục 10.4). Đặc biệt, bài báo đã chứng minh được tính \emph{nhất quán} -- tức là hối tiếc của các hàm mục tiêu này tiến về 0 sẽ kéo theo hối tiếc phân hạng tiến về 0.
\end{quote}
...
\begin{itemize}
    ...
    \item Các phân tích tập trung chủ yếu ở cấp độ phân phối xác suất (population level), chưa đi sâu vào tốc độ hội tụ hữu hạn mẫu (finite-sample) như một số định lý trong Chương 10.
