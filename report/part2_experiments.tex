...
Phần này trình bày chi tiết các thực nghiệm được thiết kế và lập trình hoàn toàn từ đầu (from scratch) bằng Python để kiểm chứng các kết quả lý thuyết trong Chương 9 của giáo trình \textit{Foundations of Machine Learning}. 
...
Để đảm bảo tính kiểm soát và khả năng kiểm chứng chính xác các thuộc tính toán học, dữ liệu giả lập được sinh ra thông qua module \texttt{data_generator.py}:
\begin{itemize}
...
\label{subsec:exp1}
Định lý 9.2 trong sách giáo khoa chỉ ra rằng sai số phân hạng thực nghiệm $\widehat{R}(h)$ của thuật toán RankBoost sau $T$ vòng lặp được chặn trên bởi tích các thừa số chuẩn hóa $Z_t$:
...
\begin{enumerate}
    ...
    \item Đường chặn nhân tử chuẩn hóa $\prod Z_t$ (đường màu cam nét liền) luôn nằm phía trên sai số huấn luyện tại mọi điểm, minh chứng thực nghiệm tuyệt đối cho Định lý 9.2.
...
Định nghĩa toán học của sách giáo khoa về Area Under the ROC Curve (AUC) là:
